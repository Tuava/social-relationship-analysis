...
const cases: TestCase[] = [
  {
    ...
    fn: async () => {
      ...
      anyClient.getEmotionList = async () => ({
        ...
        _page_info: { source: 'feeds3', partial: true, pagination_stalled: true },
      });
      ...
      assert(result.data.partial === true, 'expected stalled pagination to be marked partial');
      assert(result.data.pageInfo?.pagination_stalled === true, 'expected page metadata to be preserved');
    },
  },
  {
